...
companion object {
        ...
        var tempExerciseList=ArrayList<ExerciseModel>()//Temporary Exercise List to be used when creating exercise session to store on database
        var currentSession:Session= Session(1,"Default Session", defaultExerciseList())//Current exercise session to be used when selecting session on Main Activity

   //Get Default Lists of exercises
...
exerciseList.add(jumpingJacks)
       ...
       /* val demo=ArrayList<ArrayList<ExerciseModel>>() **IMPORTANT
     val listOfLists: List<List<String>> = ArrayList()
        */
        return exerciseList
    }
